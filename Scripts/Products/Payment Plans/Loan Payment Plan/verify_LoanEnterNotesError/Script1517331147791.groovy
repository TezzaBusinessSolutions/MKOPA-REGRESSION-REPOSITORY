...
WebUI.callTestCase(findTestCase('Products/Payment Plans/Loan Payment Plan/step_LoanPaymentPlanDeclined'), [('plan_toApprove') : 'LoanTest7'
        , ('approver_notes') : '', ('delay') : '5'], FailureHandling.STOP_ON_FAILURE)
